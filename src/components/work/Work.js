...
export const Work = () => {
  ...
  return (
    <section id="work">
      ...
      <Grid container className={classes.main} maxWidth="md">
        <div className="work_wrapper">
          {/* Cloud */}
          <div className="card_wrapper">
            <Grid item xs={12} key={work[0].id}>
              <Typography gutterBottom variant="h3" style={{ fontWeight: 500, marginBottom: '8%', }}>Cloud <br /> Engineering</Typography>
          ...
          {/* Software */}
          <div className="card_wrapper">
            <Grid item xs={12} key={work[1].id}>
              <Typography gutterBottom variant="h3" style={{ fontWeight: 500, marginBottom: '8%', }}>Software <br /> Development</Typography>
